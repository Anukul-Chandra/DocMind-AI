...
export function ChatPage() {
  ...
  return (
    <div className="docmind-page relative flex min-h-0 flex-col isolate">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 max-w-full sm:max-w-3xl mx-auto border-t border-border/40 bg-card/80 border-b-2 border-border/60 bg-gradient-to-b from-card/80 to-card/90 p-4 backdrop-blur-xl px-8 shadow-[0_2px_8px_rgba(0,0,0,0.15)]">
